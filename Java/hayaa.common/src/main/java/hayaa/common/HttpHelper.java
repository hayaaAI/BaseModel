...
public class HttpHelper {
    public static String Transaction(String requestUrl, Map<String, String> urlParam, String method)
    {
        String contentType="application/x-www-form-urlencoded";
        StringBuilder parm=new StringBuilder();
        for(Map.Entry<String, String> entry:urlParam.entrySet())
        {
            parm.append(String.format("%s=%s&", entry.getKey(),entry.getValue()));
        }
    ...
    private static  String sendGet(String url, String parm, String contentType)
    {
        String result = "";
    ...
    private static  String sendPost(String url, String parm, String contentType)
    {
