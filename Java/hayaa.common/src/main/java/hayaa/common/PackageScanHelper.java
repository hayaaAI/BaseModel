...
public class PackageScanHelper {
        ...
        try {
            ...
            while (dirs.hasMoreElements()) {
                ...
                if ("file".equals(protocol)) {
                    ...
                    List<Class<?>> tempList = scanClassByFile(packageName, filePath);
                    if (tempList != null) {
     ...
     * @param packagePath
     */
    private static List<Class<?>> scanClassByFile(String packageName,
                                                  String packagePath) {
        ...
        for (File file : dirfiles) {
            // 如果是目录 则继续扫描
            if (file.isDirectory()) {
                scanClassByFile(packageName + "." + file.getName(),
